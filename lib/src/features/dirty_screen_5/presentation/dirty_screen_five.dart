import 'package:dirty_code/src/features/dirty_screen_5/presentation/favorite_number.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const SingleChildScrollView(
        ...
        child: Column(
          children: [
            FavoriteNumber(number: 1, color: Colors.deepOrange),
            FavoriteNumber(number: 2, color: Colors.pink),
            FavoriteNumber(number: 3, color: Colors.purple),
            FavoriteNumber(number: 4, color: Colors.blue),
          ],
        ),
      ),
    );
